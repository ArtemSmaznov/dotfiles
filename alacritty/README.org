...
[[file:/usr/share/doc/alacritty/example/alacritty.yml][Example Config]]
...
* Environment
Any items in the `env` entry below will be added as environment variables. Some
...
#+begin_src yaml
define: &font_family 'Hack Nerd Font Mono'
