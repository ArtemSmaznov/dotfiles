...
* Shortcuts
The internal keyboard shortcut support in dunst is now considered deprecated and should be replaced by =dunstctl= calls. You can use the configuration of your WM or DE to bind these to shortcuts of your choice.
